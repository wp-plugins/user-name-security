...
/**
  ...
  *
  */
add_action( 'admin_init', 'seomix_sx_check_nicename', 8 );
...
/**
*
* Only on admin side and if no counter transient is found, perform a query to get the users' ids
*/
add_action( 'admin_init', 'seomix_sx_set_users_left', 9 );
function seomix_sx_set_users_left()
{
	if ( current_user_can( 'edit_users' ) && ! get_transient( 'sx_users' ) && ! defined( 'DOING_AJAX' ) ) {
		global $wpdb;
